...
def run_market_simulation():
    ...
    impacts_a = {"climate_change": 40.0, "water_use": 8.0, "resource_use_minerals_metals": 0.0002}
    ipi_a = calc.calculate(impacts_a, dqr="primary")
    price_a = bridge.get_final_price(500.0, ipi_a)
    
    # 2. THE LINEAR POLLUTER (Secondary Data, Average Efficiency)
    impacts_b = {"climate_change": 65.0, "water_use": 18.0, "resource_use_minerals_metals": 0.0006}
    ipi_b = calc.calculate(impacts_b, dqr="secondary")
